...
<body>
    <div class="container">
        ...
        <form  action="controller.php?id=<?php echo $id ;?>&action=edit" method="post">
            ...
            <div class="control-group<?php echo !empty($jobError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    Dev : <input type="checkbox" name="job" value="dev" <?php if ($user->job == "dev") echo "checked"; ?>>
                    Integrateur <input type="checkbox" name="job" value="integrateur" <?php if ($user->job == "integrateur") echo "checked"; ?>>
                    Reseau <input type="checkbox" name="job" value="reseau" <?php if ($user->job == "reseau") echo "checked"; ?>>
                </div>
            ...
            <div class="control-group  <?php echo !empty($urlError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    <input type="text" name="url" value="<?= $user->tel ?>">
            ...
            <div class="control-group <?php echo !empty($commentError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    <textarea rows="4" cols="30" name="comment"><?=$user->comment; ?></textarea>
